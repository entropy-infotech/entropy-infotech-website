...
@Component({
  selector: 'app-backend-intern',
  standalone: true,
  imports: [CommonModule, RouterLink],
  template: `
    <div class="bg-slate-50 min-h-screen">
      <!-- Logic-Heavy Hero Section -->
      <section class="relative w-full h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        <div class="absolute inset-0 z-0">
          <img src="assets/images/carrer.jpg" alt="Backend Developer Internship" class="w-full h-full object-cover object-center translate-y-[-10%]" />
        </div>
        ...
        <div class="relative z-20 container mx-auto px-6 text-center mt-12 animate-fade-in-up">
          <div class="inline-block bg-indigo-600/20 backdrop-blur-md px-5 py-2 rounded-full mb-6 border border-indigo-500/30">
            <span class="text-indigo-100 font-semibold tracking-widest text-sm uppercase">Infrastructure Hiring</span>
          </div>
          ...
          <p class="text-xl text-slate-200 max-w-2xl mx-auto leading-relaxed font-light drop-shadow-md">
            Build the robust engines that power our digital platforms.
          </p>
        </div>
      </section>
        ...
        <div class="container mx-auto px-6">
          <div class="max-w-4xl mx-auto space-y-16">
            ...
            <div class="bg-white rounded-[2.5rem] p-8 md:p-12 border border-slate-200 shadow-sm">
              <div class="mb-12">
                ...
                <p class="text-slate-600 text-lg leading-relaxed font-medium">
                  We are looking for a motivated **Backend Developer Intern** to join our team and work on real-world web applications and dashboard systems. This internship is ideal for students or recent graduates who want to strengthen their backend development skills and gain practical industry experience.
                </p>
              </div>
              ...
              <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
                ...
                <div class="bg-slate-50 p-6 rounded-3xl border border-slate-100 text-center">
                  ...
                  <p class="font-bold text-slate-900 text-xs">Final Year IT</p>
                </div>
              </div>
            ...
            <div class="bg-slate-900 rounded-[3rem] p-10 md:p-16 text-white relative overflow-hidden shadow-2xl shadow-indigo-500/10">
              ...
              <div class="absolute -right-20 -bottom-20 w-80 h-80 bg-indigo-600/10 blur-[100px] rounded-full"></div>
            </div>

            <!-- Application Section -->
            <div class="bg-white border-2 border-slate-100 rounded-[2.5rem] p-12 text-center">
              <h3 class="text-2xl font-black text-slate-900 mb-4">Ready to Build Robust Systems?</h3>
              <p class="text-slate-500 font-medium mb-10 max-w-xl mx-auto leading-relaxed">
                If you are passionate about backend development and want to gain practical experience working on real applications, we would love to hear from you.
              </p>
              <div class="flex flex-col md:flex-row items-center justify-center gap-4">
                <a routerLink="/careers/apply" [queryParams]="{role: 'Backend Developer Intern'}" class="w-full md:w-auto bg-slate-900 hover:bg-black text-white px-12 py-5 rounded-2xl font-black transition-all hover:scale-105 active:scale-95 shadow-xl shadow-slate-900/10 text-center">
...
export class BackendInternComponent {
  responsibilities = [
    'Assist in developing server-side logic for web applications',
    'Work with databases to store and manage application data',
    'Build and integrate APIs for frontend applications',
    'Maintain and improve backend performance and security',
    'Collaborate with frontend developers to implement features',
    'Help debug and fix backend-related issues'
  ];

  requirements = [
    'Basic knowledge of backend programming (Node.js/Python/PHP)',
    'Understanding of databases (MySQL, MongoDB, or PostgreSQL)',
    'Basic knowledge of APIs and server-side development',
  ...
  gains = [
    'Hands-on experience working on live backend systems',
    'Practical knowledge of APIs, databases, and server logic',
    'Opportunity to build a strong backend development portfolio',
    'Internship Certificate upon successful completion',
    'Letter of Recommendation for excellent performance'
  ];
}
