...
@Component({
  ...
  template: `
    ...
    <!-- Partners/Trust -->
    <section class=\"relative z-10 py-8 md:py-12 bg-slate-50 border-y border-slate-200 shadow-2xl\">
      <div class=\"container mx-auto px-6 overflow-hidden\">
        <p
          class=\"text-center text-slate-500 font-semibold uppercase tracking-widest text-[10px] md:text-xs mb-8\"
        >
          Trusted by Global Leaders
        </p>
        <div
          class=\"flex flex-wrap justify-around items-center grayscale opacity-50 gap-6 md:gap-8\"
        >
          <span class=\"text-xl md:text-2xl font-black italic\">TECH-CORP</span>
          <span class=\"text-xl md:text-2xl font-black italic\">GLOBAL-SYS</span>
          <span class=\"text-xl md:text-2xl font-black italic\">INNO-WEB</span>
          <span class=\"text-xl md:text-2xl font-black italic\">DATA-FLOW</span>
          <span class=\"text-xl md:text-2xl font-black italic\">CLOUD-NET</span>
        </div>
      </div>
    </section>
      ...
      <div class=\"container mx-auto px-6\">
        ...
        <div class=\"grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 max-w-6xl mx-auto\">
          ...
          >
            ...
            <h3 class=\"text-xl md:text-2xl font-bold mb-4 text-slate-900 group-hover:text-blue-600 transition-colors italic\">Web Development</h3>
            ...
            <div class=\"flex items-center justify-center md:justify-start gap-2 text-blue-600 font-bold group-hover:gap-3 transition-all\">
              Learn More 
          ...
          >
            ...
            <h3 class=\"text-xl md:text-2xl font-bold mb-4 text-slate-900 group-hover:text-indigo-600 transition-colors italic\">Analytics Dashboards</h3>
            <p class=\"text-slate-600 leading-relaxed text-sm md:text-base font-medium mb-6 text-center\">
              Transform raw data into actionable insights with real-time, interactive dashboards.
            </p>
            <div class=\"flex items-center justify-center md:justify-start gap-2 text-indigo-600 font-bold group-hover:gap-3 transition-all\">
              Learn More 
              <svg xmlns=\"http://www.w3.org/2000/svg\" class=\"h-5 w-5\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\">
                <path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M17 8l4 4m0 0l-4 4m4-4H3\" />
              </svg>
          ...
          >
            ...
            <h3 class=\"text-xl md:text-2xl font-bold mb-4 text-slate-900 group-hover:text-rose-600 transition-colors italic\">Graphic Design</h3>
            <p class=\"text-slate-600 leading-relaxed text-sm md:text-base font-medium mb-6 text-center\">
              Stunning visual communication that elevates your brand and captivates your audience.
            </p>
            <div class=\"flex items-center justify-center md:justify-start gap-2 text-rose-600 font-bold group-hover:gap-3 transition-all\">
              Learn More 
              <svg xmlns=\"http://www.w3.org/2000/svg\" class=\"h-5 w-5\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\">
                <path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M17 8l4 4m0 0l-4 4m4-4H3\" />
              </svg>
